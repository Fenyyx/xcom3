...
export const generateTokenAndSetCookie = (userId,res) => {
    const token = jwt.sign({userId},process.env.JWT_SECRET,{ //le asignamos un token a casa userId
        expiresIn: "15d" //Ponemos una fecha de inspiración, pa que no pase como en Kick
    })
    ...
    res.cookie("jwt",token,{ //Mandamos una cookie al navegador
        ...
        secure: process.env.NODE_ENV !== "development", //Nos asegurammos de que las cookies se envien en cuando estamos en desarrollo
    })
}